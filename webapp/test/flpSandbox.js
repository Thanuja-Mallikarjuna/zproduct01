		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comibmzproduct01zproduct01-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comibmzproduct01zproduct01-display": {
								"semanticObject": "comibmzproduct01zproduct01",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ibm.zproduct01.zproduct01",
									"url": sap.ui.require.toUrl("com/ibm/zproduct01/zproduct01")
								}
							}
						}
					}
